#include "window121.h"
#include "ui_window121.h"
#include <QLabel>

extern int score;

window121::window121(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::window121)
{
    ui->setupUi(this);
...
void window121::scoreChange()
{
    ui->label_score->setText(QString::number(score));
}

void window121::on_pushButton_11_clicked()
{
...
void window121::on_pushButton_answer_clicked()
{
    QString answer = ui->lineEdit_answer->text();
    if(answer == "Египетские Пирамиды" ||
       answer == "Пирамиды"            ||
       answer == "Египетские пирамиды" ||
...
void window121::on_show_hit_clicked()
{
    this->ui->stackedWidget->setCurrentIndex(1);
}

void window121::on_close_hit_clicked()
{
