#include "window221.h"
#include "ui_window221.h"
#include <QLabel>

extern int score;

window221::window221(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::window221)
{
    ui->setupUi(this);
    ...
    ui->label_3->setText("Именно на этой горе жили самые могущественные Боги, по мнению древних греков");
}
...
void window221::scoreChange()
{
    ui->label_score->setText(QString::number(score));
}

void window221::on_pushButton_11_clicked()
{
...
void window221::on_pushButton_answer_clicked()
{
...
void window221::on_show_hit_clicked()
{
    this->ui->stackedWidget->setCurrentIndex(1);
}

void window221::on_close_hit_clicked()
{
