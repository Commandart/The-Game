#include "window122.h"
#include "ui_window122.h"
#include <QLabel>

extern int score;

window122::window122(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::window122)
{
    ui->setupUi(this);
...
void window122::scoreChange()
{
    ui->label_score->setText(QString::number(score));
}

void window122::on_pushButton_11_clicked()
{
...
void window122::on_pushButton_answer_clicked()
{
    QString answer = ui->lineEdit_answer->text();
    if(answer == "Ветра"            ||
       answer == "Ветер"            ||
       answer == "Порывы ветра"     ||
       answer == "Колебания воздуха")
    {
...
void window122::on_show_hit_clicked()
{
    this->ui->stackedWidget->setCurrentIndex(1);
}

void window122::on_close_hit_clicked()
{
