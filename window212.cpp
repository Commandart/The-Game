#include "window212.h"
#include "ui_window212.h"
#include <QLabel>

extern int score;

window212::window212(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::window212)
{
    ui->setupUi(this);
    ...
    ui->label_3->setStyleSheet("border-image: url(:/img/hamon.jpg);");
}
...
void window212::scoreChange()
{
    ui->label_score->setText(QString::number(score));
}

void window212::on_pushButton_11_clicked()
{
...
void window212::on_pushButton_answer_clicked()
{
...
void window212::on_show_hit_clicked()
{
    this->ui->stackedWidget->setCurrentIndex(1);
}

void window212::on_close_hit_clicked()
{
